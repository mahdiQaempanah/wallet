...
function BudgetPage() {
    ...
    let budget_sample = [{categryName: 'پوشاک', budget: 210, spent: -10 }, { categryName: 'غذا', budget: 210, spent: 10 },
    { categryName: 'پوشاک', budget: 210, spent: -10 }, { categryName: 'همسری', budget: 210, spent: 10 },
    { categryName: 'شهریه', budget: 210, spent: -10 }, { categryName: 'میوه', budget: 210, spent: 10 },
    { categryName: 'خونه', budget: 210, spent: -10 }, { categryName: 'جنده‌خونه', budget: 210, spent: 10 }]
                ...
                >
                    ...
                    <Table.Body>
                        ...
                        <Table.Row key={index}>
                            ...
                            <Table.Cell>{EnglishDigitsToFarsi(calculateBalance(item))}</Table.Cell>
                        </Table.Row>
                        ))}
                    </Table.Body>
                </Table>
